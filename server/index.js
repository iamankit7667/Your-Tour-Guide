...
app.use(
  cors({
    origin: ["http://localhost:3000", "https://frontend-your-tour-guide.onrender.com"],
    credentials: true,
  })
);
...
process.on('uncaughtException', (err) => {
  ...
  process.exit(1); // Optional: exit the process or restart it gracefully
});

process.on('unhandledRejection', (reason, promise) => {
  console.error('Unhandled rejection at:', promise, 'reason:', reason);
  // Optional: exit the process or restart it gracefully
});
